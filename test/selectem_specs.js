...
import selectemSrc from '../src/selectem';
import selectemBuild from '../build/selectem';
...
function runSuite(selectem, srcOrBuild) {
  describe(srcOrBuild, () => {
...
describe('selectem', () => {
  runSuite(selectemSrc, 'src');
  runSuite(selectemBuild, 'build');
});
